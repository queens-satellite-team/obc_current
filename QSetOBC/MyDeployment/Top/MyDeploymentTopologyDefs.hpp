 ...
 */
namespace PingEntries {
namespace MyDeployment_blockDrv {
enum { WARN = 3, FATAL = 5 };
}
namespace MyDeployment_tlmSend {
enum { WARN = 3, FATAL = 5 };
}
namespace MyDeployment_cmdDisp {
enum { WARN = 3, FATAL = 5 };
}
namespace MyDeployment_cmdSeq {
enum { WARN = 3, FATAL = 5 };
}
namespace MyDeployment_eventLogger {
enum { WARN = 3, FATAL = 5 };
}
namespace MyDeployment_fileDownlink {
enum { WARN = 3, FATAL = 5 };
}
namespace MyDeployment_fileManager {
enum { WARN = 3, FATAL = 5 };
}
namespace MyDeployment_fileUplink {
enum { WARN = 3, FATAL = 5 };
}
namespace MyDeployment_prmDb {
enum { WARN = 3, FATAL = 5 };
}
