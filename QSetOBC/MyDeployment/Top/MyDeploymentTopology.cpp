...
Svc::Health::PingEntry pingEntries[] = {
    {PingEntries::MyDeployment_blockDrv::WARN, PingEntries::MyDeployment_blockDrv::FATAL, "blockDrv"},
    {PingEntries::MyDeployment_tlmSend::WARN, PingEntries::MyDeployment_tlmSend::FATAL, "chanTlm"},
    {PingEntries::MyDeployment_cmdDisp::WARN, PingEntries::MyDeployment_cmdDisp::FATAL, "cmdDisp"},
    {PingEntries::MyDeployment_cmdSeq::WARN, PingEntries::MyDeployment_cmdSeq::FATAL, "cmdSeq"},
    {PingEntries::MyDeployment_eventLogger::WARN, PingEntries::MyDeployment_eventLogger::FATAL, "eventLogger"},
    {PingEntries::MyDeployment_fileDownlink::WARN, PingEntries::MyDeployment_fileDownlink::FATAL, "fileDownlink"},
    {PingEntries::MyDeployment_fileManager::WARN, PingEntries::MyDeployment_fileManager::FATAL, "fileManager"},
    {PingEntries::MyDeployment_fileUplink::WARN, PingEntries::MyDeployment_fileUplink::FATAL, "fileUplink"},
    {PingEntries::MyDeployment_prmDb::WARN, PingEntries::MyDeployment_prmDb::FATAL, "prmDb"},
    {PingEntries::MyDeployment_rateGroup1::WARN, PingEntries::MyDeployment_rateGroup1::FATAL, "rateGroup1"},
    {PingEntries::MyDeployment_rateGroup2::WARN, PingEntries::MyDeployment_rateGroup2::FATAL, "rateGroup2"},
    {PingEntries::MyDeployment_rateGroup3::WARN, PingEntries::MyDeployment_rateGroup3::FATAL, "rateGroup3"},
};
